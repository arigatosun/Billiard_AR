...
{
    /// <summary>
    /// Helper class that triangulates points(gives triangles).
    /// </summary>
    public class Triangulator
    {
        ...
        {
            _points = System.Array.ConvertAll<Vector3, Vector2>(points, t => new Vector2(t.x, t.z)).ToList();
        }
